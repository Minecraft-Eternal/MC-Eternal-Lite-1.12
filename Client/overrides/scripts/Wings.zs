...
recipes.addShaped(<wings:fairy_wings>, [[<harvestcraft:fairybreaditem>, <wings:amethyst>, <harvestcraft:fairybreaditem>], [<ore:ingotNetherite>, <ore:dustFairy>, <ore:ingotNetherite>], [<ore:ingotNetherite>, null, <ore:ingotNetherite>]]);
