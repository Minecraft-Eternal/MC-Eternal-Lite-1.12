...
recipes.addShaped(<ebwizardry:arcane_tome:3>, [[<iceandfire:sea_serpent_scale_block_purple>, <ebwizardry:magic_crystal>, <iceandfire:sea_serpent_scale_block_purple>], [<wings:fairy_dust>, <ebwizardry:grand_crystal>, <wings:fairy_dust>], [<iceandfire:sea_serpent_scale_block_purple>, <ebwizardry:magic_crystal>, <iceandfire:sea_serpent_scale_block_purple>]]);
